...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("25/04/2025"), "Sextouu", "Vou Viajar para São Paulo. Abraços!", maria);
		Post post2 = new Post(null, sdf.parse("26/04/2025"), "Bom dia", "Acordei feliz hoje!", maria);
